...
Check the status of a content creation run. See [`GET /api/tasks/runs`](/api-reference/tasks/runs).

```bash
recoup content status --run <runId>
recoup content status --run <runId> --json
```
