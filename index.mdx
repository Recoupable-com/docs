...
description: "Build with the Recoup API to integrate AI-powered music industry tools into your applications."
---

# Welcome to the Recoup API

The Recoup API provides programmatic access to Recoup's AI agent platform for the music industry. Integrate artist analytics, fan segmentation, AI-powered chat, and more into your applications.
